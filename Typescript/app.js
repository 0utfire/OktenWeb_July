...
class Deputy {
    constructor(name, bribe, bribeSum) {
        this.name = name;
        this.bribe = bribe;
        this.bribeSum = bribeSum;
    }
...
class Government {
    ...
    showAllFractions() {
        this.fractionList.forEach(fr => console.log(fr.name));
    }
    showFractionByName() {
    ...
    addDeputyToFraction() {
        ...
        console.log(frToAdd, typeof frToAdd);
        frToAdd.addDeputy();
        console.log(frToAdd);
    }
}
